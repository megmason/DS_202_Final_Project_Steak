...
-   According to the code above, the most common way people like their steak prepared is Medium Rare.
...
-   Upon evaluating the graph above, it can be seen that there is an overall similarity between steak preparation when sorted by age and gender. However, the graph indicates a few differences among them. For example, the graph shows that more females like their steaks well then males, and that medium and medium rare are closer in males than in females, where there is a greater difference.
...
-   The graph above shows very similar trends among age and gender versus whether or not people eat steak or not. One noticeable difference is that there are more females who do not eat steak then males who do not eat steak across all age groups.
...
-   The heat map above shows that among genders, the preference for how steak is cooked is very similar. It can be seen that the biggest difference falls in the Medium category. Among males, medium is more popular than females.
...
-   According to the graphs above, there are not many indications that gambling affects whether or not a person eats steak or how they like their steak prepared. However, the graph of steak consumption vs gambling does show that a few more gamblers eat steak than those who do not gamble. This could be due to money situations. The graph that shows gambling vs steak preparation also shows that among gamblers, medium is closer competition to medium rare than it is among non-gamblers.
